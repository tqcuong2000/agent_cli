...
from agent_cli.core.runtime.services import SystemInfoProvider
...
def _build_app_context(
    *,
    ...
    system_info_provider = SystemInfoProvider(
        workspace_root=session_dir.parent,
    ...
    return AppContext(
        ...
        terminal_manager=_DummyTerminalManager(),  # type: ignore[arg-type]
